...
\newcommand{\Z}{\mathbb{Z}} % command for real R
...
\newcites{proleg}{Essentially Paraphrasing...}
...
\addcontentsline{toc}{subsection}{Lets Start from the Very Beginning}
...
In the present dissertation an illustrative narrative for the physical model comprehended under the name "Non-Relativistic Quantum Mechanics" will be exposed, as a means of introducing an intuitive explanation of the so called Open Quantum systems and their quandary. \nociteproleg{schrodinger:mind}
\nociteproleg{kant:critique}
\nociteproleg{bohm:wholeness}
\nociteproleg{descartes:discourse}
\nociteproleg{kulstad:leibiniz}
\nociteproleg{ordine:usefulness}
\nociteproleg{downing:berkeley}
\newpage

\bibliographystyleproleg{plain}
\bibliographyproleg{References/Bibliography} 
...
\addcontentsline{toc}{subsubsection}{2.5. Summary of the Computational Computational Schemes I}
...
\addcontentsline{toc}{subsection}{3. The Non-Classical thing: the Quantum Potential}
...
\addcontentsline{toc}{subsubsection}{3.1. Example 1: The Free Particle System}
...
\addcontentsline{toc}{subsubsection}{3.2. Example 2: The Harmonic Oscillator }
...
\addcontentsline{toc}{subsection}{ 4. The State of a Partition of the Universe}
...
\iffalse
Zer dan jakin ahal dana Unibertsoan portziñoak bakarrik accesible, orduen useless teorixe si no nos permite nada más

Klaro bakarrik unibertsoari buruzko predikziñoak badien jai dekogu!
\fi

\subsection*{A.4.1. The Conditional Wavefunction}

\addcontentsline{toc}{subsubsection}{4.1. The Conditional Wavefunction}
\iffalse
- Zelan bai ahal dotzezun jarri unibertsoan zati bateri beren wavefunction propioa. Zelan interpretetan dan, zerba eztan estado tipikjo bat normalizaziñoa eta dana kontuten hartunde.
Zelan dan lagrnagian viewra pasetie, ta ze izengo zan dana pasetie edo bakarrik partetxu bat.
\fi
...
\addcontentsline{toc}{subsection}{ 5. The Dynamics of a Partition of the Universe}


\iffalse
- Deribeu ekuaziñoak kinetic advective eta G,J bebai, kopixe ta pegeu handik, eta interprete ekuaziño resultantiek
- Explike zelakoa dan en partikular dana lagrangianoa einde
- Explikeu dana dauela entrelaceta ta dana jakin bizule eboluzionetako. El entrelazamiento con el entrono tal.
- Ein partiziño gehiau egongo bazien en general zelan izengo zire ekuaziñoak.
\fi

\subsection*{A.5.1. Effective Wavefunctions and Closed Quantum Systems}
\addcontentsline{toc}{subsubsection}{5.1. An Effective Wavefunction}
\iffalse
azaldu entanglement zer dan!

Azaldu noiz exaktamente al dogun esan que el subsistema cuántico se comporta como si fuese un sistema cuántico aislado, noiz cerrado y tal, kondiziño konkretuek jarri sobre las $G,J$.

Azaldu zer dan energía media etab oin hemendik perspektibatik
\fi

\subsection*{A.5.2. The Famous Quantum Entanglement}
\addcontentsline{toc}{subsubsection}{5.2. The Famous Quantum Entanglement}
...
\newpage
\fancyhead[R]{\em The Observable Operators}
\section*{A.6. The Hilbert Space and the Observable Operators}
\addcontentsline{toc}{subsection}{6. The Hilbert Space and the Observable Operators}

\subsection*{A.6.1. The Hilbert Space}
\addcontentsline{toc}{subsubsection}{6.1. The Hilbert Space}
...
\iffalse
- Explikeu apendixien zegaitzik L2(-inf,inf)ko funtziñoak al diren exprese en orthonormal basis expansion etc. Azaldu ze guay dauen intuiziño labur bat.

- Ket notationa azaldu informalki zelan erabiltlen dan, baia itxi klaru zer dan nahi dogune esan ket kontinuo bategaz.

- Unitary time evolution azaldu operadore moduen zelan geratzen dan ta zerba unitary etc.

- Ket notationen operadore bat zelan idazten dan jarri ta zer dan operadore hermitiko bat, eta diskleimerra gero etorko garela bueltan.
\fi

\subsection*{A.6.2. The Hamiltonian Operator and the Orchestration}
\addcontentsline{toc}{subsubsection}{6.2. The Hamiltonian Operator and the Orchestration}
...
\end{equation}
 %=\Re{\frac{\bra{x}\hat{H}\ket{\psi}}{\bra{x}\ket{\psi}}}
...
\addcontentsline{toc}{subsubsection}{6.3. Example 1: The Free Particles}
...
%Let us for a moment conduct the mental experiment where we seek for the states having the same energy for all trajectories, but without employing that this is equivalent to computing the eigenstates. 
...
%\subsection*{A.5.3. Example 2: The Uncertainty Principle}

\subsection*{A.6.5. Example 3: The Central Potential - the Angular Momentum Operator}
\addcontentsline{toc}{subsubsection}{6.5. Example 3: The Central Potential - the Angular Momentum Operator}


\subsection*{A.6.4. Example 2: The Harmonic Oscillator - the Position Operator}
\addcontentsline{toc}{subsubsection}{6.4. Example 2: The Harmonic Oscillator - the Position Operator}
...
\addcontentsline{toc}{subsubsection}{6.6. A General Observable Operator}
...
\addcontentsline{toc}{subsubsection}{6.6. The Uncertainty Principle}
% Hau igual hobeto en measuremnt ze es un efecto que se da en el measurement mas que otra cosa...
\subsection*{A.6.7. The Ket Notation}
\addcontentsline{toc}{subsubsection}{6.7. The Ket Notation}


\newpage
\fancyhead[R]{\em Overview of the Axioms}
\section*{A.7. The Axioms in Short}
\addcontentsline{toc}{subsection}{7. The Axioms in Short}
...
\addcontentsline{toc}{subsubsection}{ 7.1. The "Official" Postulates of Quantum Mechanics}

\newpage

\fancyhead[R]{\em Overview of the Axioms}
\section*{A.8. Spin in Non-Relativistic Quantum Mechanics}
\addcontentsline{toc}{subsection}{ 8. Spin in Non-Relativistic Quantum Mechanics}
\iffalse
...
\addcontentsline{toc}{subsection}{9. This was just a Medley of so Many Other Narratives!}
\iffalse
Explike ganetik orthodox, bohmian, madelung, ta many worlds, ta Schrodingerrena de la densidad de electrones! Que es la interpretación literal! El problema del physical space! Ontologias alternativas, la WF como dios, los potenciales acoplados entre sí etc.
\fi

\newpage

\bibliographystyleA{plain}
\bibliographyA{References/Bibliography} 
\newpage
...
\iffalse
Azaldu zegaitzik ezagutzeko zer dauen pasetan subsistema baten de EWF, interakzione ein behar dozule beragaz. Zelan? Proposatu von Neuman measurement Hamiltonian ta zelan akopletan deuzen posiziño bategaz de una ancilla (zer da ancilla) hau ta hau, ta jakinde posiziñoa badakizule tal o cual. Baia orduen akople hau hona ta horra, hasta tu ojo, y todo en una misma trayectoria entonces tal.  Bohr, Neumann citeu. Ein energixen neurketa baterako. Baia argi itxi zer dan pre-measuremetn ta post ta zer dakizun eta zer ez eta esan lo de Bell.
\fi
...
\addcontentsline{toc}{subsection}{2. The Properties of one or all the Universes?}
...
\iffalse
Azaldu zelan benetan measurement deitzen dotziena dala detemrinetako unibertso danatan resultau bardiñe dekiezen estadoak. 

Aklareu asozieta sistemien propiedade bakoitzagaz operadore hermitiko bat dauela usando las information B. Baia ze problema dekon orduen "measurement" deitzen dotzienak.
\fi


\fancyhead[R]{\em The Apparently Collapsing Measurement}
\section*{B.3. The Apparently Collapsing Measurement}
\addcontentsline{toc}{subsection}{3. The Apparently Collapsing Measurement}

\iffalse
Erakutsi que lo que llaman measurement en efecto causa un colapso de la función de onda, pero que eso no es en realidad lo que queremos. Osea que sí da la propiedad de la trayectoria, pero una vez perturbada.

Azaldu EWF baten bihurtzen dala geratzen dana etab etab
\fi
...
\addcontentsline{toc}{subsection}{4. Non-contextual Characterization of the Quantum System}
\iffalse
Azaldu zelan naive protocol batek emoten dozkun gure dogune, pero que implica esperanzas. Introduzidu weak measurementa eta protokoloak weak value emoten deuela. Weak value danak eztekiela zentzu operacional naive-ik!

Weak valuen demostraziñoan tendrás que demostrar que es una EWF (gray box supongo xD).

Adibidiek jarri zer dan orduen spin measurement strong bat eta local bat eta zer dan energy measurement strong ta local bat ta momentum measurement strong ta lokal bat
\fi
...
\iffalse
En general zer ahal doun egin eta zelan ahal dan demostreu el theorem akel mencione aurrerau ikusiko dogule. Por ahora let it be. Alzu demostreu EWF dala?
\fi



\section*{B.5. Link with Other Narratives}
\addcontentsline{toc}{subsubsection}{5. Link with Other Narratives}
...
\iffalse
Zer dan, zetako, zelan ulertu eta zelan ez! Eta zer zerikusi dekon con las CWF!
\fi
...
\iffalse
Hemen batezbe argi geratzie CWFekaz dekon zerikusixe y tal
\fi
...
\iffalse
Si stron measurement-like sekuentzi bat zer paseko zan Markoviano dala, zegaitzik
\fi
...
\section*{D.7. What if there was No Macro-scale?}
\addcontentsline{toc}{subsection}{7. What if there was No Macro-Scale? }

\cite{arnold:mathematical}
\begin{kapituloBerria}{Part E}{" Eee menuda flipada"}
Even Quantum Fields and Relativistic Equations Fit Well
\end{kapituloBerria}
\fancyhead[L]{Quantization of Fields and Relativity}

\addcontentsline{toc}{section}{Part E: Even Fields and Relativity Fit Well}


\fancyhead[R]{Photons}
\section*{E.1. Photons}
\addcontentsline{toc}{subsection}{1. Photons}


\section*{E.2. Phonons and other quasi-particles}
\addcontentsline{toc}{subsection}{2. Phonons and other quasi-particles}


\section*{E.3. Then, what is really Quantization? Is this a new Quantization Method?}
\addcontentsline{toc}{subsection}{3. Then, what is Quantization? Is this a new Quantization Method?}


\section*{E.4. Relativistic Tangent Universes: the Klein-Gordon Equation}
\addcontentsline{toc}{subsection}{4. Relativistic Tangent Universes: the Klein-Gordon Equation}

\newpage
\begin{kapituloBerria}{Part X}{"There is always more to say"}
Appendices
\end{kapituloBerria}
\addcontentsline{toc}{section}{Part X: Appendices}

\section*{X.1. Basic Probability Concepts and Lebesgue Integration}
\addcontentsline{toc}{subsection}{1. Basic Probability Concepts and Lebesgue Integration}

\section*{X.2. Basic Concepts about the Trajectory Ensemble $\vec{x}(\vec{\xi},t)$}
\addcontentsline{toc}{subsection}{2. Basic Concepts about the Trajectory Ensemble $\vec{x}(\vec{\xi},t)$}

\section*{X.3. Extremizing Multivariate Functionals with Constraints}
\addcontentsline{toc}{subsection}{3. Extremizing Multivariate Functionals with Constraints}

\section*{X.4. The Hilbert Space of Functions}
\addcontentsline{toc}{subsection}{4. The Hilbert Space of Functions}

\section*{X.5. Stochastic Differential Equations}
\addcontentsline{toc}{subsection}{5. Stochastic Differential Equations}
